...
import contactImage from "../../assets/images/contact-us.gif";

const ContactUs = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between gap-4 max-w-screen-xl mx-auto my-20 px-3 lg:px-0">
      ...
      <div className=" flex-1 space-y-2  lg:space-y-4">
        ...
        <h2
          data-aos="fade-up"
          className="text-2xl lg:text-4xl font-young-serif text-orange-500"
        >
          TODAY
        </h2>
        ...
        <div data-aos="fade-up" className="flex items-center gap-4 py-3">
          <Link to="https://web.facebook.com/" className="text-gray-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              className="fill-current text-gray-700 size-6 md:size-8"
            >
        ...
        <div data-aos="fade-up" className="flex  items-center gap-1 lg:gap-4">
          ...
          <div className="col-span-2 w-fit flex items-center text-[12px] lg:text-lg font-medium lg:font-bold gap-1 p-2 text-gray-700 bg-green-200 rounded-lg">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
